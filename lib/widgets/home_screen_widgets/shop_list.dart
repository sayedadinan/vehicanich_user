    ...
    return StreamBuilder<bool>(
      ...
      builder: (context, snapshot) {
        ...
        return FutureBuilder<List<Map<String, dynamic>>>(
          future: ShopRepository()
              .getShopDetails(), // Call getShopDetails directly here
          builder: (context, shopDetailsSnapshot) {
            if (shopDetailsSnapshot.connectionState ==
                ConnectionState.waiting) {
              return const HomeScreenPlaceholder();
            } else if (shopDetailsSnapshot.hasError) {
              return Center(
                child: Text('Error: ${shopDetailsSnapshot.error}'),
              );
            } else if (!shopDetailsSnapshot.hasData ||
                shopDetailsSnapshot.data!.isEmpty) {
              return const Center(
            ...
            final shopDetailsList = shopDetailsSnapshot.data!;
              ...
              builder: (context, ratingSnapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final shopDetails = shopDetailsList[index];
...
//             } else if (!nearestShopsSnapshot.hasData ||
//                 nearestShopsSnapshot.data!.isEmpty) {
//               print('Snapshot has data: ${nearestShopsSnapshot.hasData}');
//               print('Snapshot data: ${nearestShopsSnapshot.data}');
//               return const Center(
//                 child: Text('Oops Please refresh',
//                     style: TextStyle(color: Colors.white)),
//               );
